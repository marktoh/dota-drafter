            ...
            <div className="intro">
                <div className="title">
                    ...
                    <div className="attribute">
                        ...
                        <div className={`primary-attribute ${hero?.primary_attr?.toLowerCase()}`}>{hero.primary_attr}</div>
                    </div>
                </div>
                <div className="roles">{hero.roles.map(role => <span className="role" key={role}>{role}</span>)}</div>
            </div>
