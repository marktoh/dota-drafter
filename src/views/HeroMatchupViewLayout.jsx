...
function Description({ category, heroId, secondaryHeroId, description }) {
    return (
        <div className="description">
            <div className="title">
                <h3>Advantages</h3>
                <Link to={`/heroes/${heroId}/${category}/${secondaryHeroId}/edit`}>Edit</Link>
            </div>
...
function HeroMatchupViewLayout() {
    ...
    return (
        <div className="hero-matchup-view-layout">
            ...
            <Description category={category} heroId={heroId} secondaryHeroId={secondaryHeroId} description={matchup?.description} />
        </div>
    )
}
